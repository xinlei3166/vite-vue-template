// 系统维护
export default function SystemMaintenance(props: any) {
  return (
    <svg data-v-384b5a9c="" xmlns="http://www.w3.org/2000/svg" width="200" height="140" fill="none">
      ...
      <path
        fill="#fff"
        fill-rule="evenodd"
        d="m120.865 33.009 8.965 6.826 2.373-1.836-8.965-6.826q-.481.523-1.089.993-.608.468-1.284.843m-1.203-.916a8.5 8.5 0 0 0 1.305-.828 7.248 7.248 0 0 1 0 0 8.5 8.5 0 0 1-1.305.828"
        clip-rule="evenodd"
      ></path>
      ...
      <defs>
        ...
        >
          ...
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
          <feGaussianBlur
            result="effect1_foregroundBlur_216_313"
            stdDeviation="25"
          ></feGaussianBlur>
        </filter>
        <filter

// 浏览器不兼容
export default function BrowserIncompatible(props: any) {
  return (
    <svg data-v-384b5a9c="" xmlns="http://www.w3.org/2000/svg" width="200" height="140" fill="none">
      ...
      <g mask="url(#a)">
        <path
          ...
          clip-rule="evenodd"
        ></path>
        <g filter="url(#filter2_f_22_990)" opacity=".3">

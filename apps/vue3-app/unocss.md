...
> colorPrimary及依赖的变量，会根据设置的值变化。其他变量同理。
...
const vars = {
  ...
  primaryBg: '#e6f6ff',
  primaryBgHover: '#a3dcff',
  primaryBorder: '#7ac8ff',
  primaryBorderHover: '#52b1ff',
  primaryHover: '#2997ff',
  primaryActive: '#005fd4',
  primaryTextHover: '#2997ff',
  primaryText: '#0077fa',
  primaryTextActive: '#005fd4',
  successBg: '#f6ffed',
...
## antd 样式变量, 部分变量 light 和 dark 模式值会变化。
> defaultAlgorithm 算法会生成 light 模式下的值，darkAlgorithm 算法会生成 dark 模式下的值。
```js
// import { theme } from 'ant-design-vue'
// const { defaultAlgorithm, darkAlgorithm, defaultSeed } = theme
// const mapToken = defaultAlgorithm({
...
//   colorPrimary: '#0077FA'
// })
// const darkMapToken = darkAlgorithm({
//   ...defaultSeed,
//   colorPrimary: '#0077FA'
// })
